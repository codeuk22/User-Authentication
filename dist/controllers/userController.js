...
const emailConfig_1 = require("../config/emailConfig/emailConfig");
exports.userRegistration = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const newUser = new User_1.default(Object.assign(Object.assign({}, req.body), { password: hashPassword }));
    ...
    try {
        ...
        if (req.body.newPassword) {
            ...
            if (compare) {
                ...
                const updateUser = yield User_1.default.findByIdAndUpdate({ _id: user === null || user === void 0 ? void 0 : user._id }, { $set: Object.assign(Object.assign({}, req.body), { password: hashPassword }) }, { new: true });
        ...
        const updateUser = yield User_1.default.findByIdAndUpdate({ _id: user === null || user === void 0 ? void 0 : user._id }, { $set: req.body }, { new: true });
        return res.status(301).send({
...
exports.sendUserPasswordResetEmail = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let info = yield emailConfig_1.transporter.sendMail({
...
exports.resetUserPassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updateUser = yield User_1.default.findByIdAndUpdate({ _id: user === null || user === void 0 ? void 0 : user._id }, { $set: { password: hashPassword }, $inc: { version: 1 } }, { new: true });
        if (updateUser) {
            return res.status(200).send({
